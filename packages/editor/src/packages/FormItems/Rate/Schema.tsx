import IconSelectSetting from "@/packages/components/IconSelectSetting";
...
const FormSetting = [
    ...
    // }
    {
        ...
        render: (form: FormInstance) => {
            return <IconSelectSetting initialValue={'StarFilled'} form={form} label={'自定义字符'} name={['formWrap', 'character']} />;
        },
    },
]
