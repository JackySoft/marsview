            ...
            <g id="编组-17" transform="translate(108.000000, 7.000000)">
              <g id="编组-41" transform="translate(0.000000, 23.000000)">
                ...
                <g id="编组-6" transform="translate(19.000000, 0.000000)">
                  <g id="编组-18" fill="url(#linearGradient-2)" stroke="#A5B1FF" stroke-width="0.5">
                    <g id="编组-20">
                      <path
                  ...
                  <text id="输入" font-family="PingFangSC-Regular, PingFang SC" font-size="7" font-weight="normal" line-spacing="7" fill="#1F1F1F">
                    <tspan x="4" y="10">
                      输入
                    </tspan>
                  </text>
